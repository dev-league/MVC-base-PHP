...
(function(factory) {
                        ...
                        if (col.mData === i) {
                            ...
                            if (sort !== null || filter !== null) {
                                col.mData = {
                                    _: i + ".display",
                                    sort: sort !== null ?
                                        i + ".@data-" + sort : undefined,
                                    type: sort !== null ?
                                        i + ".@data-" + sort : undefined,
                                    filter: filter !== null ?
                                        i + ".@data-" + filter : undefined
                                };
    ...
    function _fnLanguageCompat(lang) {
        ...
        if (lang) {
            ...
            if (!lang.sEmptyTable &&
                zeroRecords &&
                defaults.sEmptyTable === "Nenhum resultado disponivel"
            ) {
                ...
                if (src !== "") {
                    ...
                    for (var i = 0, iLen = a.length; i < iLen; i++) {
                        ...
                        if (arrayNotation) {
                            ...
                            if ($.isArray(data)) {
                                for (
                                    var j = 0, jLen = data.length; j < jLen; j++
                                ) {
                                    out.push(
    ...
    function _fnFeatureHtmlProcessing(settings) {
        return $("<div/>", {
                id: !settings.aanFeatures.r ?
                    settings.sTableId + "_processing" : null,
            ...
            if (sel.nodeName) {
                ...
                if (rowIdx !== undefined) {
                    ...
                    return aoData[cellIdx.row] &&
                        aoData[cellIdx.row].nTr === sel.parentNode ? [cellIdx.row] : [];
                } else {
    ...
    DataTable.defaults = {
        ...
        oLanguage: {
             ...
             *    } );
             */
            sEmptyTable: "Nenhum resultado disponivel",
